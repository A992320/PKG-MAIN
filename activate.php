    ...
    <style>
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .request-license-btn {
            ...
            margin-top: 8px;
            padding: 11px;
            background: linear-gradient(135deg, var(--red), #a80716);
        ...
        .request-license-btn:hover {
            color: #fff;
            filter: brightness(1.08);
            transform: translateY(-1px);
            box-shadow: 0 7px 20px rgba(229,9,20,0.30);
        }
        .request-license-btn:active { transform: translateY(0); }
        .request-license-btn i { font-size: 14px; }
        .machine-note {
            margin-top: 10px;
            font-size: 11px;
            color: var(--faint);
...
<div class="wrapper">
    <div class="card">
        ...
        <div class="machine-block">
            ...
            <a class="request-license-btn"
               href="http://shshadmin.duckdns.org:8080/iptv/mgmt.php"
               target="_blank" rel="noopener noreferrer">
                <i class="fas fa-id-card"></i>
                طلب رخصة لتفعيل النظام
            </a>
        ...
        <div class="info-block">
            ...
            <ul class="steps">
                ...
                <li><div class="step-num">2</div><span>اضغط زر "طلب رخصة لتفعيل النظام" أو أرسل المعرف عبر واتساب</span></li>
