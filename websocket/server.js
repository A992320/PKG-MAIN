...
function originAllowed(origin) {
  // Non-browser health probes do not send Origin. Browser clients must use an
  // explicitly configured application origin unless the administrator opts in
  // to wildcard mode.
  return !origin || ALLOW_ANY_ORIGIN || ALLOWED_ORIGINS.includes(origin);
}
