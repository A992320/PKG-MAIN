...
<div class="mbody">
  ...
  <div class="fg" style="font-size:.8rem;color:var(--t3);background:rgba(56,189,248,.06);padding:10px 12px;border-radius:8px">
    <i class="fas fa-hard-drive" style="color:#38bdf8"></i>
    يختار النظام قرص التخزين تلقائياً وفق نوع المحتوى، المساحة الحرة، وحجوزات النقل. لا تُنقل الملفات القديمة إلا من «إعادة التوازن» الصريحة.
  </div>
