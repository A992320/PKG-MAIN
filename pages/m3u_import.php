<section id="m3u-import" class="sec">
  ...
  <div style="display:flex;align-items:flex-start;gap:10px;background:rgba(56,189,248,.08);border:1px solid rgba(56,189,248,.28);border-radius:12px;padding:12px 14px;margin-bottom:18px;font-size:.82rem;line-height:1.7;color:var(--t2,#c9c9c9)">
    <i class="fas fa-circle-info" style="color:#38bdf8;margin-top:3px"></i>
    <div><?= $t["import_hg_note"] ?? "الأقسام التي يُنشئها الاستيراد لا تظهر في الصفحة الرئيسية من تلقاء نفسها — استيراد واحد قد يُنشئ عشرات الأقسام فتغرق الصفحة. اذهب إلى <b>الأقسام ← مجموعات الصفحة الرئيسية</b> واضمم ما تريد عرضه إلى مجموعة؛ الأقسام المستوردة مجمّعة هناك بحسب مصدرها." ?></div>
  </div>
