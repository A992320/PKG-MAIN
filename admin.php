...
if (function_exists('homeGroupsEnsureSchema')) { homeGroupsEnsureSchema(); } // تهيئة جداول المجموعات مرة واحدة
...
foreach (['dashboard','categories','channels','m3u_import','xtream','api_settings','series',
          ...
          'frontend_control','subscriptions','coupons','subscribers','storage_multi','_rest_view'] as $__p) {
