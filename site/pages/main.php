...
<main style="padding-top:88px;padding-bottom:60px" id="mainContent">
  ...
  <!-- [SHS-HG] عرض أقسام مجموعة الصفحة الرئيسية (المستوى الثاني قبل المحتوى) -->
  <div id="homeGroupSection" class="hidden" style="padding:0 20px">
    <button class="back-btn" onclick="shsCloseGroupView()"><span class="lcn"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg></span> الرئيسية</button>
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:16px;font-size:1.15rem;font-weight:800;color:#fff">
      <span id="homeGroupTitle">المجموعة</span>
    </div>
    <div class="shs-hg-grid" id="homeGroupGrid"></div>
  </div>

  <div id="categoryViewSection" class="hidden" style="padding:0 20px">
    <button class="back-btn" onclick="closeCategoryView()"><span class="lcn"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg></span> <span id="catBackLabel">الرئيسية</span></button>
