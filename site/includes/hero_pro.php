...
/* شريط علوي زجاجي فوق البانر: يظهر لون وصورة البانر من خلاله بدلاً من
   تدرج أسود يحجبها، مع ضباب كافٍ للحفاظ على وضوح البحث والأزرار. */
body.shsx-has-hero .navbar:not(.scrolled){
  background:linear-gradient(180deg,rgba(25,54,91,.30) 0%,rgba(13,30,57,.12) 58%,rgba(13,30,57,.03) 100%)!important;
  backdrop-filter:blur(13px) saturate(135%)!important;
  -webkit-backdrop-filter:blur(13px) saturate(135%)!important;
  border-bottom-color:rgba(190,223,255,.16)!important;
  box-shadow:inset 0 1px rgba(255,255,255,.10),0 9px 24px rgba(1,7,20,.12)!important;
}
/* العنوان يُقرأ مرة واحدة فقط؛ العنوان الشبحي كان يكرر اسم القناة فوق
   خلفية البانر ويشوّش على البوستر المتحرك. */
.shsx-ghost{display:none!important}
/* لا نكرر البوستر في الخلفية: الصور التي تحمل أسماء أو شعارات (مثل 4K)
   كانت تظهر مرتين، واحدة واضحة وواحدة باهتة. الخلفية الآن إضاءة زجاجية
   ثابتة تبرز البوستر الأمامي من دون نسخ للنص أو الشعار. */
.shsx-bg{
  inset:0!important;
  background-image:radial-gradient(860px 440px at 78% 18%,rgba(55,154,255,.31),transparent 70%),radial-gradient(620px 500px at 18% 78%,rgba(150,86,255,.24),transparent 74%),linear-gradient(135deg,#091323,#0d1930 54%,#140e29)!important;
  background-position:center!important;background-size:cover!important;
  filter:none!important;transform:none!important;
}
.shsx-slide.is-on .shsx-bg{animation:none!important}
body.shsx-has-hero .cat-navbar{background:linear-gradient(180deg,rgba(10,10,12,.55),rgba(10,10,12,.25))!important}
/* هوية الشعار داخل الزجاج: تدرج بارد ولمعة دقيقة بدل اللون الأزرق المسطح
   والظل الأحمر القديم، لتتطابق مع حدود البطاقات وأزرار الشريط. */
body.shsx-has-hero .navbar .nav-logo-text,.navbar .nav-logo-text{
  display:inline-block!important;
  background:linear-gradient(105deg,#ecf7ff 0%,#78c6ff 43%,#9e93ff 100%)!important;
  -webkit-background-clip:text!important;background-clip:text!important;
  color:transparent!important;
  letter-spacing:-.035em!important;
  text-shadow:0 3px 18px rgba(95,170,255,.30)!important;
}
/* اسم المنصة يتكرر في الشريط والتذييل والقائمة؛ نعطيه الهوية نفسها في كل
   موضع كي تبقى العلامة متجانسة مهما كانت الشاشة المفتوحة. */
.site-footer__name,.nx-brand,.shsb-brand b,.shsb-foot b{
  display:inline-block!important;
  background:linear-gradient(105deg,#ecf7ff 0%,#78c6ff 43%,#9e93ff 100%)!important;
  -webkit-background-clip:text!important;background-clip:text!important;
  color:transparent!important;
  text-shadow:0 3px 18px rgba(95,170,255,.24)!important;
}
